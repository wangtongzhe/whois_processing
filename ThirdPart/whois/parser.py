...
class WhoisCn(WhoisEntry):
    ...
    regex = {
        ...
        'registrant_email': 'Registrant Contact Email: *(.+)',
        'name_servers': 'Name Server: *(.+)',
    }
...
class WhoisHk(WhoisEntry):
    ...
    regex = {
        ...
        'address': 'Address: *(.+)',
        'updated_date': 'Updated Date: *(.+)',
        'Domain Name Commencement Date': 'Creation Date: *(.+)',
        'Expiry Date': 'Registrar Registration Expiration Date: *(.+)',
        'registrant_email': '\nEmail: *(.+)',
